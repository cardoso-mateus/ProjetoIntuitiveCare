...
/**
 * Classe utilizada para criação de métodos que possibilitem realizar o download dos documentos indicados pelo teste e arquivar o conjunto em um
 * mesmo arquivo ZIP.
 * 
...
public class ScrapingDados {
	...
	/**
	 * Este método faz o scraping dos links dos arquivos PDF e inicia os campos para uso posterior, a inteção é de usar o scraping para reduzir
	 * ao máximo o hard coding.
	 * Os campos contém a url de cada pdf a ser baixado e os títulos dos arquivos de acordo com o HTML do site de origem.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Este método utiliza os o preenchimento dos campos para fazer o download de cada um dos arquivos e também para nomear cada arquivos de acordo
	 * com o que foi publicado no site de origem.
	 * Foram utilizados métodos estáticos internos para que, com pouco ajuste, possa ser mudada a quantidade de arquvivos baixados, permitindo então
	 * fazer o download de menos anexos ou incluir posteriormente mais documentos utilizando a mesma implementação.
	 * @throws Throwable
	 */
	...
	/**
	 * Este método realiza a compactação dos documentos baixados em um aquivo ZIP único e deleta da pasta de origem os arquivos copiados.
	 * Também foram utilizados métodos estáticos internos para a compactação individual de cada arquivo a fim de permitir, de forma simples, a alteração
	 * na quantidade de arquivos incluidos no ZIP final, bastando utilizar a mesma implemetação para possiveis arquivos novos ou diminuição da seleção atual.
	 * @throws Throwable
	 */
